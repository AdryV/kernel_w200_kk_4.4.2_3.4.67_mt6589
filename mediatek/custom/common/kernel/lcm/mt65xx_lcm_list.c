...
extern LCM_DRIVER hx8394_dsi_vdo_hd_lcm_drv;
...
extern LCM_DRIVER lg4591_dsi_vdo_hd_lcm_drv;
...
#if defined(HX8394_DSI_VDO_HD)			//line <add hx8394a> 2014 08 21
	&hx8394_dsi_vdo_hd_lcm_drv,
#endif
...
#if defined(LG4591_DSI_VDO_HD)			//line <add lg4591_dsi> 2014 08 21
	&lg4591_dsi_vdo_hd_lcm_drv,
#endif
...
#if defined(NT35596_FHD_DSI_VDO_YKL)
	&nt35596_fhd_dsi_vdo_ykl_lcm_drv,
#endif

#if defined(LVDS_WXGA)
	&lvds_wxga_lcm_drv,
#endif

#if defined(LVDS_MIPI)
	&sn65dsi83_lcm_drv
#endif
